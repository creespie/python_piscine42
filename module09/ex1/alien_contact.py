...
class Contact(BaseModel):
    ...
    message_received: Annotated[str, Field(default="", max_length=500)]
    ...
    def validator(self) -> "Contact":
        ...
        elif not self.is_verified and self.contact_type == ContactType.PHYSICAL:
            raise ValueError("Physical contact reports must be verified")
        elif self.witness_count <= 3 and self.contact_type == ContactType.TELEPATHIC:
            raise ValueError("Telepathic contact requires at least 3 witnesses")
        elif self.signal_strength > 7.0 and self.message_received == "":
...
def main():
    ...
    print(f"Type: {test.contact_type}")
